...
const InputField = ({type , placeholder , name , handleChange , address}) => (
    ...
    text-gray-500 focus:border-primary focus:ring-primary focus:ring-2'
    type={type}
            ...
            <div className='flex flex-col-reverse md:flex-row justify-between mt-10'>
                <div className='flex-1 max-w-md'>
                    <form className='space-y-3 mt-6 text-sm' onSubmit={onSubmitHandler}>
                        ...
                        <button className='w-full text-white bg-primary uppercase hover:bg-primaryDull transition cursor-pointer py-3 mt-6'>
                            Save Address
                        </button>
