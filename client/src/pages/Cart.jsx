...
const Cart = () => {
    const {products, cartItems, removeFromCart, getCartCount,
        ...
        <div className="flex flex-col md:flex-row mt-12">
            ...
            <div className="flex-1 max-w-4xl">
                ...
                {cartArray.map((product, index) => (
                    <div key={index} className="grid grid-cols-[2fr_1fr_1fr] items-center text-sm md:text-base font-medium pt-3">
                    ...
                    <div className="relative flex justify-between items-start mt-2">
                        ...
                        {showAddress && (
                            <div className="absolute top-12 py-1 bg-white border border-gray-300 text-sm w-full z-10">
                                ...
                                <p onClick={() => navigate('/add-address')} className="text-primary text-center cursor-pointer p-2 hover:bg-primaryDull">
                                    Add address
                                </p>
                            </div>
                        )}
